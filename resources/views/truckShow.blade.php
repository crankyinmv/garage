...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
@if($action == 'create')
                <div class="card-header">Add a new truck</div>
@else                
                <div class="card-header">Update information for {{ $vehicle->make . ' ' . $vehicle->model}}</div>
@endif
                <div class="card-body">
                    <form method="POST" action="/trucks{{$action == 'update' ? '/'.$vehicle->id : ''}}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="bed_length" class="col-md-4 col-form-label text-md-end">Bed Length</label>

                            <div class="col-md-6">
                                <input id="bed_length" type="number" min='1' class="form-control @error('bed_length') is-invalid @enderror" name="bed_length" 
                                value="{{$action=='create'?old('bed_length'):$vehicle->bed_length}}" required autofocus>
